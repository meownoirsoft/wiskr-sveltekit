-- Complete branching setup migration - FIXED VERSION
-- This version has corrected SQL syntax
...
-- Step 4: Update existing messages to use 'main' branch (FIXED)
UPDATE messages SET branch_id = 'main' WHERE branch_id IS NULL OR branch_id = '';

-- Step 5: Create main branch for all existing projects (FIXED)
