  ...
  >
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col" style="background-color: var(--bg-modal, white);">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
        <div>
          <h2 id="settings-modal-title" class="text-2xl font-bold text-gray-900 dark:text-gray-100">Project Settings</h2>
          <p class="text-gray-600 dark:text-gray-400 mt-1">
            Manage configuration for <strong class="text-gray-900 dark:text-gray-100">{project?.name || 'this project'}</strong>
          </p>
        </div>
        <button
          on:click={closeModal}
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        {:else if activeTab === 'general'}
          <div>
            <div class="mb-6">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">General Settings</h3>
              <p class="text-gray-600 dark:text-gray-400">Basic project configuration options.</p>
            </div>
            <div class="space-y-6">
              <div>
              ...
              <div>
                <label for="project-description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Description</label>
                <textarea 
              ...
              <div class="flex justify-between items-center pt-6 border-t border-gray-200 dark:border-gray-700">
                <p class="text-sm text-gray-500 dark:text-gray-400">More general settings will be added here in future updates.</p>
                <button
                  ...
                  class="flex items-center gap-2 px-6 py-3 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors" style="background-color: var(--color-accent);"
                >
                  <Save size="16" />
