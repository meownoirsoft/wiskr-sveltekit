<script>
  ...
  const componentMap = {
    ...
    'AppSettingsModal': () => import('./AppSettingsModal.svelte'),
    'FormatModal': () => import('./FormatModal.svelte'),
    'BranchModal': () => import('./BranchModal.svelte'),
    'NewProjectModal': () => import('./NewProjectModal.svelte'),
    'ProjectSettingsModal': () => import('./ProjectSettingsModal.svelte'),
